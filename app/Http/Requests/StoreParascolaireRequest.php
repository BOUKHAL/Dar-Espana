...
class StoreParascolaireRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'jour_evenement' => 'required|date|after:today',
    ...
    public function messages(): array
    {
        return [
            ...
            'jour_evenement.after' => 'La date de l\'événement doit être dans le futur.',
